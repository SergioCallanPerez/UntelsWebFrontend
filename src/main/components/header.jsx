...
const renderMenuItems = (items) =>
    items.map((item) =>
        Array.isArray(item.items) ? (
            <NavDropdown key={item.title} title={item.title} drop="end">
                ...
                <Navbar.Collapse id="navbarScroll">
                    ...
                    >
                        {Object.entries(menuData).map(([key, value]) => (
                            <NavDropdown key={key} title={key} id="navbarScrollingDropdown">
                                {Array.isArray(value) ? renderMenuItems(value) : Object.entries(value).map(([subKey, subItems]) => (
                                    <NavDropdown key={subKey} title={subKey} drop="end">
